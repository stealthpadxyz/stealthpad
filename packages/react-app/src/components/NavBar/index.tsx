        ...
        <Left>
          <Header>
            ...
            <div className="flex space-x-4 ml-4 mt-2">
              <div className="bg-gray-900 p-4">Trending</div>
              <div className="bg-gray-900 mt-4">#1 MFurie</div>
              <div className="bg-gray-900 mt-4">#2 XGC</div>
              <div className="bg-gray-900 mt-4">#3 Xbob</div>
              <div className="bg-gray-900 mt-4">#4 DONUT</div>
              <div className="bg-gray-900 mt-4">#5 McMNY</div>
              <div className="bg-gray-900 mt-4">#6 MKF</div>
              <div className="bg-gray-900 mt-4">#7 MOTN</div>
              <div className="bg-gray-900 mt-4">#8 DMST</div>
              <div className="bg-gray-900 mt-4">#9 ECT</div>
              <div className="bg-gray-900 mt-4">#10 LNDRr</div>
            </div>
          </Header>
        </Left>
